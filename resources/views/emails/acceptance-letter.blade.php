...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <h2 style="color: #1a1a1a; margin-top: 0;">KIELCE</h2>
        </div>
        ...
        <p>
            If you have any questions, please contact us at <a href="mailto:international@kielceuniversity.pl.pl">international@kielceuniversity.pl</a>.
        </p>
