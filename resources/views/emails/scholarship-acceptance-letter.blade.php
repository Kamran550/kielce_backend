...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #1a1a1a; margin-bottom: 10px;">KIELCE</h1>
            <h2 style="color: #1a1a1a; margin-top: 0;">KIELCE UNIVERSITY</h2>
        </div>
        ...
        <p>
            ...
            <a href="mailto:international@kielceuniversity.pl">international@kielceuniversity.pl</a> or <a href="mailto:admission@kielceuniversity.pl">admission@kielceuniversity.pl</a>.
        </p>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; font-size: 12px; color: #666;">
            ...
            <p style="margin-top: 15px;">
                Tel: +48 579277493<br>
                Website: www.kielceuniversity.pl
            </p>
        </div>
    </div>
</body>
